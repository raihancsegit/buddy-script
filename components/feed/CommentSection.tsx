...
export default function CommentSection({
  postId, comments, currentUserId,
}: { postId: string; comments: any[]; currentUserId?: string }) {
  ...
  return (
    <div className="_feed_inner_timeline_cooment_area">
      {/* ── Comment Input Box (exact HTML structure) ── */}
      <div className="_feed_inner_comment_box">
        <form onSubmit={handleSubmit} className="_feed_inner_comment_box_form">
          <div className="_feed_inner_comment_box_content">
            <div className="_feed_inner_comment_box_content_image">
              <img src={session?.user?.image || "/assets/images/comment_img.png"} alt="" className="_comment_img" />
            </div>
          ...
          <div className="_feed_inner_comment_box_icon">
            ...
            {content.trim() && (
              <button type="submit" disabled={loading}
                style={{ background: "#377DFF", color: "#fff", border: "none", borderRadius: "6px", padding: "4px 12px", marginLeft: "6px", cursor: "pointer", fontSize: "13px" }}>
                {loading ? "..." : "Post"}
              </button>
            )}
          </div>
      ...
      {/* ── Comment List (exact HTML structure) ── */}
